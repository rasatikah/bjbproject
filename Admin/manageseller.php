    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="index.php"><span>BJBshop | Laman Admin</span></a></h1>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="manageuser.php">Urus Pengguna</a></li>
                        <li class="active"><a href="manageselller.php">Urus Peniaga</a></li>
                        <li ><a href="category.php">Urus Kategori</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="product-bit-title text-center">
                        <h2>Selamat Datang ke Akaun Admin</h2>
                    </div>
                </div>
            </div>
        </div>
